...
class PushPenguinsUITests: XCTestCase {
    ...
    func testExample() {
        ...
        element.children(matching: .image).element(boundBy: 1).tap()
        element.children(matching: .image).element(boundBy: 2).tap()
        element.children(matching: .image).element(boundBy: 3).tap()
        
        let image = element.children(matching: .image).element(boundBy: 0)
        image.tap()
        image.tap()
        image.tap()
        element.children(matching: .image).element(boundBy: 7).tap()
        element.children(matching: .image).element(boundBy: 8).tap()
        element.children(matching: .image).element(boundBy: 9).tap()
        image.tap()
        image.tap()
        image.tap()
    }
